...
public class TaskGetSimilarTastes implements RequestListener {
	
	Message _mess;
	public TaskGetSimilarTastes(Integer pageSize, Integer nowPage, Message mess) {
      ...
      //  (int now_page, int page_size, int order_type, RequestListener listener)
        statusApi.friendsTimeline(nowPage, pageSize, 2, this);
        _mess = mess;
	}
