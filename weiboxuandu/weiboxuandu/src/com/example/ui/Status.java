...
public class Status extends WeiboResponse  implements Serializable  {
	...
	public static List<Status> constructListStatus(String res) throws WeiboException {
	...
	public static StatusWapper constructWapperStatus(String res) throws WeiboException {
